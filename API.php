...
class API extends \Piwik\Plugin\API {
    ...
    public static function getMostVisitedPages($idSite, $lastMinutes = 20)
    {
        ...
        $sql = "SELECT    COUNT(*) as number, llva.idaction_url, la.name, la2.name as url, AVG(TIME_TO_SEC(llva.time_spent_ref_action)/60) as time 
				...
				AND       llva.idsite = ?
				GROUP BY llva.idaction_url ORDER BY number desc limit 10";
